...
<body>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{url('verif-infos-connexion-a')}}">
       @csrf
        <div class="form-group">
          <label for="exampleInputEmail1">Identifiant</label>
          <input type="text" id="Login" name="login" class="form-control" required="true">
        </div>
        <div class="form-group">
